...
namespace ADAL
{
	...
	partial interface Constants
	{
		...
		byte[] ADALFrameworkVersionString { get; }
	}

	// typedef void (^ADAuthenticationCallback)(ADAuthenticationResult *);
	delegate void ADAuthenticationCallback (ADAuthenticationResult arg0);
	...
	delegate void ADParametersCompletion (ADAuthenticationParameters arg0, ADAuthenticationError arg1);
	...
	delegate void LogCallback (AdalLogLevel arg0, string arg1, string arg2, nint arg3, NSDictionary arg4);

	// typedef void (^ADLoggerCallback)(ADAL_LOG_LEVEL, NSString *, BOOL);
	delegate void ADLoggerCallback (AdalLogLevel arg0, string arg1, bool arg2);
